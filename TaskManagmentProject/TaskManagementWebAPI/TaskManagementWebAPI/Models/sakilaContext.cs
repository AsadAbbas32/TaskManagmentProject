...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=localhost;port=3306;database=sakila;uid=root;pwd=asad57922", x => x.ServerVersion("8.0.19-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Task>(entity =>
            {
                ...
                entity.HasComment("a simple task table");
                ...
                entity.Property(e => e.Taskheading)
                    .HasColumnName("taskheading")
